...
do
  ...
  describe '#call' do
    ...
    describe 'with icon: value' do
      ...
      let(:snapshot) do
        <<~HTML
          <div class="alert has-text-danger is-#{type} mb-1">
            <span class="icon has-text-weight-bold">
    ...
    describe 'with type: "danger"' do
      ...
      let(:snapshot) do
        <<~HTML
          <div class="alert has-text-#{component.theme.danger_color} is-#{type} mb-1">
            <span class="icon has-text-weight-bold">
    ...
    describe 'with type: "info"' do
      ...
      let(:snapshot) do
        <<~HTML
          <div class="alert has-text-#{component.theme.info_color} is-#{type} mb-1">
            <span class="icon has-text-weight-bold">
    ...
    describe 'with type: "success"' do
      ...
      let(:snapshot) do
        <<~HTML
          <div class="alert has-text-#{component.theme.success_color} is-#{type} mb-1">
            <span class="icon has-text-weight-bold">
    ...
    describe 'with type: "warning"' do
      ...
      let(:snapshot) do
        <<~HTML
          <div class="alert has-text-#{component.theme.warning_color} is-#{type} mb-1">
            <span class="icon has-text-weight-bold">
