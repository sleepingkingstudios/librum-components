...
RSpec.describe Librum::Components::Views::Resources::Edit, type: :component do
  ...
  describe '#call' do
    ...
    describe 'with a resource with an update form component' do
      ...
      example_class 'Spec::Books::UpdateForm', Librum::Components::Base \
      do |klass|
